...
##2023/10/07新增MACD的計算
    ...
    def getReplyMsg(self, symbol, name):
        ...
        replyMsg += "*成交量: " + str(round(df['Volume'][-1]/1000, 2)) + "張\n"
        replyMsg += "*K(9): " + str(round(df['K'][0], 2)) + "\n"
        replyMsg += "*D(9): " + str(round(df['D'][0], 2)) + "\n\n"
        replyMsg += "===指標參考===" + "\n"                
        ...
        replyMsg += "*DIFF[12,26,9]指標: " + str(round(df['DIF'][-1],3)) + "\n"
